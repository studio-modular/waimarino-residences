...
import type { Section11Block } from "@/payload-types";
...
export function Section11({ slides }: Section11Block) {
  ...
  return (
    <section className="dg-section relative w-full">
      <Carousel
        className="md:px-16 w-full relative"
        opts={{ align: "center", inViewThreshold: 0.8, loop: true, startIndex: 1, watchSlides: true }}
        plugins={[Autoplay(), ClassNames()]}
      >
        <CarouselContent className="!ml-0 carousel-classnames">{slidesMarkup}</CarouselContent>
